...
//             // Step 1: Find an index that can delete BOTH sides
//             for (int i = 0; i < sb.length(); i++) {
...
//             // Step 2: If no such index exists → stop
//             if (bestIndex == -1) break;

//             char c = sb.charAt(bestIndex);

//             // Step 3: Delete nearest right first
//             for (int j = bestIndex + 1; j < sb.length(); j++) {
//                 if (sb.charAt(j) == c) {
//                     sb.deleteCharAt(j);
//                     break;
//                 }
...
//             // Step 4: Delete nearest left
//             for (int j = bestIndex - 1; j >= 0; j--) {
//                 if (sb.charAt(j) == c) {
//                     sb.deleteCharAt(j);
//                     break;
//                 }
